...
export default function DirectoryCardView({ program, saved = false, savingPending = false, saveError, onSave, onViewDetails }: DirectoryCardViewProps) {
  ...
  return (
    <article className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm border border-surface-container-highest hover:border-primary/40 hover:shadow-md transition-all flex flex-col [overflow-wrap:anywhere]">
