        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-on-surface-variant font-body mb-10 leading-relaxed max-w-xl">
              Browse a verified directory of rent assistance, shelter, legal aid, and waitlist programs across Portland and Vancouver — without the 211 runaround.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Link to="/resources" className="bg-primary text-on-primary px-8 py-4 rounded-full font-semibold text-base shadow-[0px_8px_24px_rgba(0,83,221,0.15)] hover:bg-primary-dim hover:shadow-[0px_12px_32px_rgba(0,83,221,0.25)] transition-all duration-300 transform hover:-translate-y-0.5 text-center">
                Find resources
              </Link>
              <Link to="/waitlist" className="bg-surface-container-highest text-surface-tint px-8 py-4 rounded-full font-semibold text-base hover:bg-surface-variant transition-colors text-center">
                Track waitlists
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-surface-container-lowest p-8 rounded-2xl shadow-[0px_8px_24px_rgba(45,51,55,0.04)] md:-translate-y-4">
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                Resource type, county, and current status — three filters, no questionnaire, no account required.
              </p>
            </div>
          ...
          <div className="bg-surface-container-lowest rounded-3xl p-10 lg:p-16 shadow-[0px_12px_40px_rgba(45,51,55,0.05)] border border-surface-container-highest/50 flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-[45%] flex flex-col gap-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-headline font-bold text-on-surface text-lg">Verified resources</h4>
